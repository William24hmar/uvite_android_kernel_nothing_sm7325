...
AR		?= $(CROSS_COMPILE)ar
NM		?= $(CROSS_COMPILE)nm
||||||| parent of f6870926f9b0 (Kbuild, lto: Add Link Time Optimization support)
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
=======
LDFINAL		= $(LD)
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
>>>>>>> f6870926f9b0 (Kbuild, lto: Add Link Time Optimization support)
...
CC_VERSION_TEXT = $(subst $(pound),,$(shell $(CC) --version 2>/dev/null | head -n 1 | sed 's/\#//g'))
